...
static CONTRACT_VALUES: Lazy<HashMap<String, f64>> = Lazy::new(|| {
    ...
    let mut m: HashMap<String, f64> = vec![
        ...
        ("linear_swap.APT/USDT", 0.001),
        ("linear_swap.ARB/USDT", 0.001),
        ("linear_swap.AVAX/USDT", 0.0001),
        ("linear_swap.BCH/USDT", 0.00001),
        ("linear_swap.BIGTIME/USDT", 1.0),
        ("linear_swap.BLUR/USDT", 0.001),
        ("linear_swap.BMEX/USDT", 0.001),
        ("linear_swap.BNB/USDT", 0.0001),
        ("linear_swap.BTC/USDT", 0.000001),
        ("linear_swap.CRO/USDT", 0.01),
        ("linear_swap.CYBER/USDT", 1.0),
        ...
        ("linear_swap.FIL/USDT", 1.0),
        ("linear_swap.FTM/USDT", 0.01),
        ("linear_swap.FTT/USDT", 0.0001),
        ...
        ("linear_swap.MEME/USDT", 1.0),
        ("linear_swap.NEAR/USDT", 0.001),
        ("linear_swap.OP/USDT", 0.001),
        ("linear_swap.ORBS/USDT", 1.0),
        ("linear_swap.PEPE/USDT", 1.0),
        ("linear_swap.PYTH/USDT", 1.0),
        ("linear_swap.SAND/USDT", 0.001),
        ("linear_swap.SEI/USDT", 1.0),
        ("linear_swap.SHIB/USDT", 1.0),
        ("linear_swap.SOL/USDT", 0.0001),
        ("linear_swap.SUI/USDT", 0.001),
        ("linear_swap.TIA/USDT", 1.0),
