...
mod l2_snapshot {
    ...
    fn inverse_future() {
        ...
        assert_eq!(orderbook.bids[0].quantity_contract, Some(827.0));

        assert_eq!(orderbook.bids[2].price, 30624.3);
    ...
    fn linear_future() {
        ...
        assert_eq!(orderbook.bids[0].quantity_contract, Some(0.024));

        assert_eq!(orderbook.bids[2].price, 30561.0);
    ...
    fn inverse_swap() {
        ...
        assert_eq!(orderbook.bids[0].quantity_contract, Some(12984.0));

        assert_eq!(orderbook.bids[2].price, 30401.4);
    ...
    fn linear_swap() {
        ...
        assert_eq!(orderbook.bids[0].quantity_contract, Some(0.482));

        assert_eq!(orderbook.bids[2].price, 30429.90);
