...
mod l2_snapshot {
    ...
    fn spot() {
        ...
        // let raw_msg =
        // r#"{"code":"00000","msg":"success","requestTime":1654232411024,"data":{"asks"
        // :[["30413.33","0.0141"],["30413.37","0.0112"],["30413.41","0.0179"]],"bids":
        // [["30413.27","0.0296"],["30413.23","0.0484"],["30413.19","0.1272"]],"
        // timestamp":"1654232411024"}}"#;
        let symbol = Some("BTCUSDT_SPBL");
        ...
        let orderbook =
            &parse_l2_snapshot(EXCHANGE_NAME, MarketType::Spot, raw_msg, symbol, None).unwrap()[0];
        ...
        assert_eq!(orderbook.seq_id, None);
        assert_eq!(orderbook.prev_seq_id, None);
        //[["23139.91","0.7697"],["23139.76","1.2558"],["23139.56","0.0120"]] descending
        ...
        //[["23141.01","0.0763"],["23141.16","0.1244"],["23141.4","0.0120"]] ascending
    ...
    fn inverse_swap() {
        //let raw_msg =
        // r#"{"code":"00000","msg":"success","requestTime":1654234201087,"data":{"asks"
        // :[["30521","1.661"],["30521.5","2.312"],["30522","0.139"]],"bids":[["3.
        // 052E+4","0.256"],["30519.5","0.482"],["30519","0.079"]],"timestamp":"
        // 1654234201087"}}"#;
        ...
        let orderbook =
            &parse_l2_snapshot(EXCHANGE_NAME, MarketType::InverseSwap, raw_msg, symbol, None)
                .unwrap()[0];
        ...
        assert_eq!(orderbook.seq_id, None);
        assert_eq!(orderbook.prev_seq_id, None);
        //"bids":[["23145","0.107"],["23143","0.363"],["23141.5","0.518"]] descending
        ...
        //"asks":[["23146","3.666"],["23146.5","5.562"],["2.315E+4","0.5"]]  ascending
    ...
    fn linear_swap() {
        //let raw_msg =
        // r#"{"code":"00000","msg":"success","requestTime":1654234229348,"data":{"asks"
        // :[["30544","13.904"],["30544.5","2.678"],["30545","4.923"]],"bids":[["30543",
        // "0.756"],["30542.5","0.749"],["30542","15.438"]],"timestamp":"1654234229348"
        // }}"#;
        ...
        assert_eq!(orderbook.seq_id, None);
        assert_eq!(orderbook.prev_seq_id, None);
        //"bids":[["23133","16.282"],["23132.5","0.074"],["23132","0.039"]] descending
        ...
        //"asks":[["23133.5","28.326"],["23134","3.027"],["23134.5","128.392"]] ascending
