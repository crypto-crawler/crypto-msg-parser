...
mod candlestick {
    ...
    fn inverse_swap() {
        ...
        assert_eq!(8.075_908_760_556_816, candlestick_msg.volume);
        assert_eq!(Some(253900.0), candlestick_msg.quote_volume)
    }
    ...
    fn linear_swap() {
        ...
        assert_eq!(3.1468, round(candlestick_msg.volume));
